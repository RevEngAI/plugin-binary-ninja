...
EXTRA = {
    "binary_upload": {
        "status": "yes",
        "note": "No explicit command or feature to upload binaries. Binaries are uploaded on creation of a new analysis only.",
    },
    "check_analysis_status": {"status": "yes"},
...
def build_manifest():
    features = {}
    for _feature_class, (feature_id, status) in FEATURE_CLASSES.items():
